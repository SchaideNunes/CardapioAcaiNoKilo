  ...
  return (
    <SmoothScrollProvider isDisabled={showCart || showCheckout}>
      <main className="min-h-screen bg-[#241220] flex flex-col relative text-white">
        ...
        {cartCount > 0 && (
          <footer className="fixed bottom-0 left-0 w-full z-50 bg-[#241220] border-t border-white/5 p-4 sm:p-6 flex items-center justify-between shadow-[0_-10px_30px_rgba(0,0,0,0.5)] animate-in slide-in-from-bottom-4 duration-300 lg:hidden">
        ...
        {showCheckout && (
          <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center">
            ...
            <div className="relative w-full max-w-lg bg-[#241220] rounded-t-3xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 max-h-[90vh] overflow-y-auto animate-in slide-in-from-bottom-full sm:zoom-in-95 duration-300">
              ...
              <div className="flex gap-3 mt-8">
                ...
                <button onClick={handleFinish} disabled={!isCheckoutValid()} className={cn("flex-[2] py-4 rounded-xl font-heading text-lg flex items-center justify-center gap-2 transition-all uppercase", isCheckoutValid() ? "bg-[#25D366] text-[#241220] hover:bg-[#22c35e] shadow-lg active:scale-95" : "bg-white/5 text-white/20 cursor-not-allowed")}>
